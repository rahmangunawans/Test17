...
- July 30, 2025. Successfully integrated IQiyi API for M3U8 streaming and subtitle support: added iqiyi_url and subtitle_urls columns to Episode model with database migration, enhanced admin panel with IQiyi form fields and real-time extraction functionality, updated video player with IQiyi as Server 4 option, implemented automatic M3U8 extraction and subtitle loading, added JSON filter for proper subtitle handling, created comprehensive multi-server architecture supporting M3U8, Embed, Torrent, and IQiyi streaming
